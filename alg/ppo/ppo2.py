        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("loss", reuse=False):
                    ...
                    ratio = tf.exp(self.old_neglog_pac_ph - neglogpac, name='ratio')
                    pg_losses = -tf.multiply(self.advs_ph, ratio, name='pg_losses')
                    pg_losses2 = -tf.multiply(self.advs_ph,  tf.clip_by_value(ratio,
                                                                        1.0 - self.clip_range_ph,
                                                                        1.0 + self.clip_range_ph,
                                                                              name='clip_ratio'), name='pg_losses2')
                    ...
                    print('-------------------------------------------')
                    print('\n\n\nneglogpac.shape:\t{}\n'.format( neglogpac.get_shape()))
                    print('\nself.action_ph.shape:\t{}\n'.format( self.action_ph.get_shape()))
                    print('\nself.old_neglog_pac_ph.shape:\t{}\n'.format( self.old_neglog_pac_ph.get_shape()))
                    print('\npg_losses.shape:\t{}\n'.format( pg_losses.get_shape()))
                    print('\npg_losses2.shape:\t{}\n'.format( pg_losses2.get_shape()))
                    print('\nself.pg_loss.shape:\t{}\n'.format( self.pg_loss.get_shape()))
                    print('\nratio.shape:\t{}\n'.format( ratio.get_shape()))
                    print('-------------------------------------------')
...
# o, returns, masks, actions, values, neglogpacs, states = runner.run()
